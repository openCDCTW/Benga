...
def sequences_path(instance, filename):
    return "sequences/{0}/{1}".format(instance.batch_id.id, instance.file.name)


def profiles_path(instance, filename):
    return "profiles/{0}/{1}".format(str(instance.id.id), "profile-" + str(instance.id.id)[0:8] + ".tsv")


def dendrograms_png_path(instance, filename):
    return "dendrograms_png/{0}/{1}".format(str(instance.id.id), "dendrogram-" + str(instance.id.id)[0:8] + ".png")


def dendrograms_pdf_path(instance, filename):
    return "dendrograms_pdf/{0}/{1}".format(str(instance.id.id), "dendrogram-" + str(instance.id.id)[0:8] + ".pdf")


def dendrograms_svg_path(instance, filename):
    return "dendrograms_svg/{0}/{1}".format(str(instance.id.id), "dendrogram-" + str(instance.id.id)[0:8] + ".svg")


def dendrograms_emf_path(instance, filename):
    return "dendrograms_emf/{0}/{1}".format(str(instance.id.id), "dendrogram-" + str(instance.id.id)[0:8] + ".emf")


def dendrograms_newick_path(instance, filename):
    return "dendrograms_newick/{0}/{1}".format(str(instance.id.id), "dendrogram-" + str(instance.id.id)[0:8] + ".newick")
