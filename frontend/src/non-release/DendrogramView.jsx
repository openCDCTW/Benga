	...
	query_dengrogram(){
		...
		if(this.state.png_file == undefined){
			...
			.then(result => this.setState(state => ({
				png_file: '/cgMLST/' + result.png_file, 
				pdf_file: '/cgMLST/' + result.pdf_file,
				svg_file: '/cgMLST/' + result.svg_file,
				newick_file: '/cgMLST/' + result.newick_file })));
    	...
    	if(this.state.png_file == undefined){
    		...
    		return (
				<div>
					...
					<br />
					<div style={{ display:'flex', justifyContent:'center', alignItems:'center'}}>
						<Link to="/cgMLST/non-release/clustering" style={{ textDecoration:'none' }}>
