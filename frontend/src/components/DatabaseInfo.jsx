		...
		if(this.props.database == 1){
			return (
				<div>
					...
					<Typography component="p" style={{ width:'90%',textAlign: 'justify',
					margin:'auto',fontSize:16 }}>
						&nbsp;&nbsp;&nbsp;&nbsp;cgMLST database contains cgMLST profiles for 
						the strains with genomic sequences deposited in the NCBI database. 
					...
					<Typography component="p" style={{ width:'90%',textAlign: 'justify',
					margin:'auto',fontSize:16 }}>
						&nbsp;&nbsp;&nbsp;&nbsp;cgMLST@Taiwan was developed in the laboratories 
						of Centers for Disease Control, Ministry of Health and Welfare, 
						Taiwan by Yueh-Hua Tu, Yi-Syong Chen, Bo-Han Chen, Yen-Yi Liu, Yu-Ping Hong, 
						Ru-Hsiou Teng, You-Wun Wang, and Chien-Shun Chiou.
					</Typography>
					<br />
